...
if (isset($_GET['editid'])) {
	...
	$edit_quary = $db->query("UPDATE tbl_galaxy_art_board SET board_status = :status, board_edited_user_id = :edited_user_id, board_edited_date_time = :edited_date_time WHERE board_auto_id = :id", $edit_array);
