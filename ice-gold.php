...
$board_table_data = $db->query("SELECT * FROM tbl_galaxy_icegold_board ORDER BY board_auto_id  
	DESC");
...
if (isset($_GET['editid'])) {
	...
	$edit_quary = $db->query("UPDATE tbl_galaxy_icegold_board SET board_status = :status, board_edited_user_id = :edited_user_id, board_edited_date_time = :edited_date_time WHERE board_auto_id = :id", $edit_array);
