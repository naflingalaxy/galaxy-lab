...
//	$db->bind("useremail","farshad@3cs.asia");
//	$db->bind("userpassword","21232f297a57a5a743894a0e4a801fc3");

	// 2. Bind more parameters
	// $db->bindMore(array("useremail"=>"farshad@3cs.asia","userpassword"=>"21232f297a57a5a743894a0e4a801fc3"));		

	// 3. Or just give the parameters to the method
	//$result = $db->query("SELECT * FROM tbl_user WHERE user_email = :useremail AND user_password = :userpassword", array("useremail"=>"farshad@3cs.asia","userpassword"=>"21232f297a57a5a743894a0e4a801fc3"));
