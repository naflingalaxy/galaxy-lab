                                ...
                                <!--  <div class="col-md-6 mb-3">
                                 ...
                                 <div class="col-md-6 mb-3">
                                    <label for="validationDefault03">QTY <code>(unit)</code></label>
                                          <input type="text" class="form-control" oninput="this.value=this.value.replace(/[^0-9]/g,'');" autocomplete="off" id="validationDefault03" name="qty" maxlength="6" required>
                              ...
                              <div class="iq-card-body">
                                 <div class="row">
                                    ...
                                    <div class="col-lg-12 mt-3">
                                       <h6 class="card-title text-uppercase text-secondary mb-0">Ice Gold</h6>
                                          ...
                                          <tr>
                                             ...
                                             <td class="edit-record">
                                                ...
                                                <div class="d-inline-block">
                                                   ...
                                                   <a href="<?php echo HTTP_PATH."ice-gold?editid=".$board_table_data[$x]['board_auto_id']."&status=active"; ?>" class="badge edit-btn approve">Approve</a>
                                                   <a href="<?php echo HTTP_PATH."ice-gold?editid=".$board_table_data[$x]['board_auto_id']."&status=cancelled"; ?>" class="badge edit-btn cancel">Cancel</a>
