                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title"> Add Paint</h4>
                           </div>
                        </div>
                           ...
                           <form>
                              <div class="form-row">
                                 <div class="col-md-6 mb-3">
                                    <label for="validationTooltip04">paint type</label>
                                    <select class="custom-select" id="validationTooltip04" required>
                                       <option selected disabled value="">Choose...</option>
                                       <?php 
                                          $page_data_names = $db->query("SELECT item_name, item_id FROM tbl_galaxy_stock_items WHERE item_section = '3'");
                                          if ($page_data) {
                                              for ($s=0; $s < count($page_data_names); $s++) { ?>
                                          <option value="<?php echo $page_data_names[$s]['item_id']; ?>"><?php echo $page_data_names[$s]['item_name']; ?></option>
                                       <?php }} ?>
                                 ...
                                 <div class="col-md-6 mb-3">
                                    ...
                                    <select class="custom-select" id="validationTooltip04" required>
                                       <option selected disabled value="">Choose...</option>
                                       <option value="sithara">Sithara</option>
                                 ...
                                 <div class="col-md-6 mb-3">
                                    <label for="validationDefault03">Price <code>(per Kg)</code></label>
                                 ...
                                 <div class="col-md-6 mb-3">
                                    <label for="validationDefault03">QTY <code>(unit Kg)</code></label>
                                          <input type="text" class="form-control" oninput="this.value=this.value.replace(/[^0-9]/g,'');" id="validationDefault03" maxlength="6" required>
